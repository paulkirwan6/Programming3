...
public final class HourlyWorker extends Employee {
	...
	public HourlyWorker(String first, String last, double wagePerHour, double hoursWorked, int year, int month, int date, int hour, int minute) throws InvalidDateException {
